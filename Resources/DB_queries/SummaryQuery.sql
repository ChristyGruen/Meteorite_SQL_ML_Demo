...
select 'state' as category, s.state as value, min(mm.mass_grams) as min_mass_gr, round(cast(avg(mm.mass_grams)as numeric),0) as avg_mass_gr, max(mm.mass_grams) as max_mass_gr
